...
SimpleRouter::group( [ 'prefix' => site_url() ], function () {
	...
	SimpleRouter::get( '/registreren', 'WebsiteController@registreren' )->name( 'registreren' );
	SimpleRouter::post( '/registreren', 'WebsiteController@registerprocess' )->name( 'registreren.process' );
